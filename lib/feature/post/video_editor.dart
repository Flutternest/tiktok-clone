...
import 'package:tiktokclone/feature/post/utils/export_service.dart';
import 'package:tiktokclone/feature/post/video_popup_result.dart';
...
class _VideoEditorState extends State<VideoEditorPage> {
  ...
  void _exportVideo() async {
    ...
    //     if (!mounted) return;
    //     print('successfully done exporting');
  ...
  String formatter(Duration duration) => [
        duration.inMinutes.remainder(1).toString().padLeft(2, '0'),
